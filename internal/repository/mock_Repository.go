...
import (
	...
	entity "github.com/SaulBenitez/inventory/internal/entity"
...
func (_m *MockRepository) SaveProduct(ctx context.Context, name string, description string, price float64, createdBy int64) error {
